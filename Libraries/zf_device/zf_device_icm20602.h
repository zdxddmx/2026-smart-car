...
#define ICM20602_USE_INTERFACE       SOFT_SPI                        // 默认使用软件 SPI 方式驱动

#if (ICM20602_USE_INTERFACE==HARDWARE_SPI)
//====================================================硬件 SPI 驱动====================================================
	#define ICM20602_SPI_SPEED          ((uint32)10 * 1000 * 1000U)      // 硬件 SPI 速率
	#define ICM20602_SPI                SPI_0                            // 硬件 SPI 号
	#define ICM20602_SPC_PIN            SPI0_CH3_SCLK_P43                // 硬件 SPI SCK 引脚
	#define ICM20602_SDI_PIN            SPI0_CH3_MOSI_P40                // 硬件 SPI MOSI 引脚
	#define ICM20602_SDO_PIN            SPI0_CH3_MISO_P41                // 硬件 SPI MISO 引脚
	#define ICM20602_CS_PIN             (IO_P42)                         // CS 片选引脚
	#define ICM20602_CS(x)              (P42 = x)
//====================================================硬件 SPI 驱动====================================================
...
//====================================================软件 IIC 驱动====================================================
	#define ICM20602_SOFT_IIC_DELAY     (0)                              // 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
	#define ICM20602_SCL_PIN            (IO_P40)                         // 软件 IIC SCL 引脚 连接 MPU6050 的 SCL 引脚
	#define ICM20602_SDA_PIN            (IO_P41)                         // 软件 IIC SDA 引脚 连接 MPU6050 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#endif
...
// 返回参数     void
// 使用示例     float dat = icm20602_acc_transition(icm20602_acc_x);           // 单位为 g(m/s^2)
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
...
// 返回参数     void
// 使用示例     float dat = icm20602_gyro_transition(icm20602_gyro_x);         // 单位为 °/s
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
