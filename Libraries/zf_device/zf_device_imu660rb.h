...
//====================================================硬件 SPI 驱动====================================================
	...
	#define IMU660RB_SPC_PIN            SPI0_CH3_SCLK_P43             	// 硬件 SPI SCK 引脚
	#define IMU660RB_SDI_PIN            SPI0_CH3_MOSI_P40             	// 硬件 SPI MOSI 引脚
	#define IMU660RB_SDO_PIN            SPI0_CH3_MISO_P41              	// 硬件 SPI MISO 引脚
	#define IMU660RB_CS_PIN             (IO_P42)                       	// CS 片选引脚
