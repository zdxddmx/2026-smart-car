...
#define TSL1401_AO_PIN          (ADC_CH3_P13)                                   // 对应第一个 TSL1401 的 AO 引脚
#define TSL1401_AO_PIN2         (ADC_CH4_P14)                                   // 对应第二个 TSL1401 的 AO 引脚

// TSL1401 的控制引脚定义 多个 TSL1401 建议将控制引脚直接并联
#define TSL1401_SI_PIN          (IO_P36)                                            // TSL1401 的 SI 引脚定义
#define TSL1401_CLK_PIN         (IO_P37)                                            // TSL1401 的 CLK 引脚定义
