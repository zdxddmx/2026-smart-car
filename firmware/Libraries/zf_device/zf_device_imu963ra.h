...
#define IMU963RA_USE_INTERFACE       SOFT_SPI                        // 默认使用硬件 SPI 方式驱动
#if (IMU963RA_USE_INTERFACE==HARDWARE_SPI)
//====================================================硬件 SPI 驱动====================================================	
	#define IMU963RA_SPI_SPEED          				((uint32)10 * 1000 * 1000U)                 // 硬件 SPI 速率
	#define IMU963RA_SPI                				SPI_0                                       // 硬件 SPI 号
	#define IMU963RA_SPC_PIN            				SPI0_CH3_SCLK_P43                           // 硬件 SPI SCK 引脚
	#define IMU963RA_SDI_PIN            				SPI0_CH3_MOSI_P40                           // 硬件 SPI MOSI 引脚
	#define IMU963RA_SDO_PIN            				SPI0_CH3_MISO_P41                           // 硬件 SPI MISO 引脚
	#define IMU963RA_CS_PIN             				(IO_P42)                                 	// CS 片选引脚
